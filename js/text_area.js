...
var text_quiz = {
	go : function(){
		var text = document.getElementsByClassName('text_quiz_area');
	...
	answerCheck : function(){
		...
		var index = parseInt(this.parentNode.getElementsByClassName('text_quiz_area')[0].getAttribute('id').split('text')[1]);
		...
		if(answer_area.length!=0){
			...
			//여러개 inputbox 초기화
			for(i=0;i<this.parentNode.getElementsByClassName('text_quiz_area').length;i++){
				this.parentNode.getElementsByClassName('text_quiz_area')[i].value = "";
			}
			//this.parentNode.getElementsByClassName('text_quiz_input')[0].value = "";
		}else{
			...
			var coma = "";
			for(i=0;i<this.parentNode.getElementsByClassName('text_quiz_area').length;i++){
				i < this.parentNode.getElementsByClassName('text_quiz_area').length-1 ? coma=", " : coma="";
